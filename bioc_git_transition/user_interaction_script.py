...
class edit_repo:
    ...
    def set_edit_repo(self, package):
        ...
        repository = SERVER + self.bioc_git_repo + "/" + package
    ...
    def release_branch(self, package, new_release):
        ...
        self.commit_message("bump x.y.z versions to even 'y' prior to creation of " + new_release, package_dir)
        ...
        self.version_bump(package, release=True)
        # Commit message
        self.commit_message("bump x.y.z versions to odd 'y' after creation of " + new_release, package_dir)
